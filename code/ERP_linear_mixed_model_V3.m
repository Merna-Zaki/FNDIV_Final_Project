...
%% Figure 3: plots predicted models on the corresponding CUE scatterplots
...
for group_i = 1:4
    ...
    for cond_j = 1:3
        ...
        if cond_j == 1
            ...
            % Cue Half 1
            c_h1 = scatter(cue_values(idx_cue_1), cue_values(idx_cue_1), ...
                    60, 'o', 'MarkerEdgeColor', 'k' , 'MarkerFaceColor', 'r', 'MarkerFaceAlpha', 0.4);  % Actual values (x = y)
                    hold on;
            m1 = scatter(cue_values(idx_cue_1), predicted_cue(idx_cue_1), ...
                    60, '*', 'MarkerEdgeColor', 'r', 'MarkerFaceAlpha', 0.6);  % Predicted

            % Cue Half 2
            c_h2 = scatter(cue_values(idx_cue_2), cue_values(idx_cue_2), ...
                    60, 'o', 'MarkerEdgeColor', 'b' , 'MarkerFaceColor', 'b', 'MarkerFaceAlpha', 0.4);  % Actual
            m2 = scatter(cue_values(idx_cue_2), predicted_cue(idx_cue_2), ...
                    60, '*', 'MarkerEdgeColor', 'k', 'MarkerFaceAlpha', 0.6);  % Predicted

            if subplot_idx == 1
               legend([c_h1 m1 c_h2 m2],{'Half 1 - actual', 'Half 1 - predicted', 'Half 2 - actual', 'Half 2 - predicted'}, ...
                'Location', 'best');
            end
...
%% Figure 4: plots predicted models on the corresponding FEEDBACK scatterplots
...
for group_i = 1:4
    ...
    for cond_j = 1:2
        ...
        if cond_j == 1
            ...
            % Negative Half 1
            n_h1 = scatter(neg_values(idx_neg_1), neg_values(idx_neg_1), ...
                    60, 'o', 'MarkerEdgeColor', 'k' , 'MarkerFaceColor', 'r', 'MarkerFaceAlpha', 0.4);  % Actual values (x = y)
                    hold on;
            m3 = scatter(neg_values(idx_neg_1), predicted_fb_neg(idx_neg_1), ...
                    60, '*', 'MarkerEdgeColor', 'r', 'MarkerFaceAlpha', 0.6);  % Predicted

            % Negative Half 2
            n_h2 = scatter(neg_values(idx_neg_2), neg_values(idx_neg_2), ...
                    60, 'o', 'MarkerEdgeColor', 'k' , 'MarkerFaceColor', 'b', 'MarkerFaceAlpha', 0.4);  % Actual
            m4 = scatter(neg_values(idx_neg_2), predicted_fb_neg(idx_neg_2), ...
                    60, '*', 'MarkerEdgeColor', 'k', 'MarkerFaceAlpha', 0.6);  % Predicted

            if subplot_idx == 1
               legend([n_h1 m3 n_h2 m4],{'Half 1 - actual', 'Half 1 - predicted', 'Half 2 - actual', 'Half 2 - predicted'}, ...
                'Location', 'best');
            end
