...
timepoints= cue_data{1, 2:end}; % time window is the same for both cue and feedback
...
% ---- Creating Cue Plot ----
figure (1); clf;
sgtitle ('Cue 1st Half vs Cue 2nd Half');


% Plotting OUD Active ERP
subplot(2,2,1);
plot(timepoints, OUD_Active_cue_h1_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, OUD_Active_cue_h2_Cz, 'Color', 'm', 'LineStyle', '-')
...
subplot(2,2,2);
plot(timepoints, OUD_Sham_cue_h1_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, OUD_Sham_cue_h2_Cz, 'Color', 'm', 'LineStyle', '-')
ylim([-4, 8]); % sets the y-axis range
yticks(-4:2:8); % adds a line in increaments of 2
ylabel ('Amplitude (µV)')
xline(0, 'k', 'LineWidth', 1) % adds a black line at stimlus onset (x=0)
...
subplot(2,2,3);
plot(timepoints, Ctrl_Active_cue_h1_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, Ctrl_Active_cue_h2_Cz, 'Color', 'm', 'LineStyle', '-')
ylim([-4, 8]); % sets the y-axis range
yticks(-4:2:8); % adds a line in increaments of 2
ylabel ('Amplitude (µV)')
xline(0, 'k', 'LineWidth', 1) % adds a black line at stimlus onset (x=0)
...
subplot(2,2,4);
plot(timepoints, Ctrl_Sham_cue_h1_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, Ctrl_Sham_cue_h2_Cz, 'Color', 'm', 'LineStyle', '-')
ylim([-4, 8]); % sets the y-axis range
yticks(-4:2:8); % adds a line in increaments of 2
ylabel ('Amplitude (µV)')
xline(0, 'k', 'LineWidth', 1) % adds a black line at stimlus onset (x=0)
...
figure (2);
sgtitle ('AB & CD Cues during 1st Half vs 2nd Half');


% Plotting OUD Active ERP
subplot(2,2,1);
plot(timepoints, OUD_Active_cue_h1_AB_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, OUD_Active_cue_h2_AB_Cz, 'Color', 'g', 'LineStyle', '--')
plot(timepoints, OUD_Active_cue_h1_CD_Cz, 'Color', 'm', 'LineStyle', '-')
plot(timepoints, OUD_Active_cue_h2_CD_Cz, 'Color', 'm', 'LineStyle', '--')
...
% Plotting OUD Sham ERP
subplot(2,2,2);
plot(timepoints, OUD_Sham_cue_h1_AB_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, OUD_Sham_cue_h2_AB_Cz, 'Color', 'g', 'LineStyle', '--')
plot(timepoints, OUD_Sham_cue_h1_CD_Cz, 'Color', 'm', 'LineStyle', '-')
plot(timepoints, OUD_Sham_cue_h2_CD_Cz, 'Color', 'm', 'LineStyle', '--')
...
% Plotting Healthy Controls Active ERP
subplot(2,2,3);
plot(timepoints, Ctrl_Active_cue_h1_AB_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, Ctrl_Active_cue_h2_AB_Cz, 'Color', 'g', 'LineStyle', '--')
plot(timepoints, Ctrl_Active_cue_h1_CD_Cz, 'Color', 'm', 'LineStyle', '-')
plot(timepoints, Ctrl_Active_cue_h2_CD_Cz, 'Color', 'm', 'LineStyle', '--')
...
% Plotting Healthy Controls Sham ERP
subplot(2,2,4);
plot(timepoints, Ctrl_Sham_cue_h1_AB_Cz, 'Color', 'g', 'LineStyle', '-')
hold on;
plot(timepoints, Ctrl_Sham_cue_h2_AB_Cz, 'Color', 'g', 'LineStyle', '--')
plot(timepoints, Ctrl_Sham_cue_h1_CD_Cz, 'Color', 'm', 'LineStyle', '-')
plot(timepoints, Ctrl_Sham_cue_h2_CD_Cz, 'Color', 'm', 'LineStyle', '--')
...
% Plotting OUD Active ERP
subplot(2,2,1);
plot(timepoints, OUD_Active_pos_h1_Cz, 'Color', 'b', 'LineStyle', '-')
hold on;
plot(timepoints, OUD_Active_neg_h1_Cz, 'Color', 'r', 'LineStyle', '-')
plot(timepoints, OUD_Active_pos_h2_Cz, 'Color', 'b', 'LineStyle', '--')
plot(timepoints, OUD_Active_neg_h2_Cz, 'Color', 'r', 'LineStyle', '--')
...
% Plotting OUD Sham ERP
subplot(2,2,2);
plot(timepoints, OUD_Sham_pos_h1_Cz, 'Color', 'b', 'LineStyle', '-')
hold on;
plot(timepoints, OUD_Sham_neg_h1_Cz, 'Color', 'r', 'LineStyle', '-')
plot(timepoints, OUD_Sham_pos_h2_Cz, 'Color', 'b', 'LineStyle', '--')
plot(timepoints, OUD_Sham_neg_h2_Cz, 'Color', 'r', 'LineStyle', '--')
...
% Plotting Healthy Controls Active ERP
subplot(2,2,3);
plot(timepoints, Ctrl_Active_pos_h1_Cz, 'Color', 'b', 'LineStyle', '-')
hold on;
plot(timepoints, Ctrl_Active_neg_h1_Cz, 'Color', 'r', 'LineStyle', '-')
plot(timepoints, Ctrl_Active_pos_h2_Cz, 'Color', 'b', 'LineStyle', '--')
plot(timepoints, Ctrl_Active_neg_h2_Cz, 'Color', 'r', 'LineStyle', '--')
...
% Plotting Healthy Controls Sham ERP
subplot(2,2,4);
plot(timepoints, Ctrl_Sham_pos_h1_Cz, 'Color', 'b', 'LineStyle', '-')
hold on;
plot(timepoints, Ctrl_Sham_neg_h1_Cz, 'Color', 'r', 'LineStyle', '-')
plot(timepoints, Ctrl_Sham_pos_h2_Cz, 'Color', 'b', 'LineStyle', '--')
plot(timepoints, Ctrl_Sham_neg_h2_Cz, 'Color', 'r', 'LineStyle', '--')
